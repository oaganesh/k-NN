...
public class SegmentProfilerUtil {
    ...
    public static Optional<SegmentProfilerState> getSegmentProfileState(final LeafReader leafReader, String fieldName) throws IOException {
        final SegmentProfileKNNCollector tempCollector = new SegmentProfileKNNCollector();
        leafReader.searchNearestVectors(fieldName, new float[0], tempCollector, null);
        return Optional.ofNullable(tempCollector.getSegmentProfilerState());
    }
}
